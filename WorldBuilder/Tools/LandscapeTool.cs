...
namespace WorldBuilder.Tools {
    public class LandscapeTool : ITool {
        ...
        private bool _showExportWindow;
        private int _exportIteration;
        private bool _exportDatsOverwriteFiles;
        private string _exportError;
        private string _exportSuccess;
        private string _exportOutDirectory = @"C:\Turbine\Asheron's Call\";
        ...
        private void UpdateChunkGeneration() {
            ...
            var projection = _cameraManager.Current.GetProjectionMatrix(((float)Width / Height), 1.0f, 80000f);
