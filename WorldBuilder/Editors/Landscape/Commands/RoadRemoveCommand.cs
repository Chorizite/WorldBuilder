...
namespace WorldBuilder.Editors.Landscape.Commands {
    public class RoadRemoveCommand : ICommand {
        ...
        public string Description => "Remove road points";

        public bool CanExecute => true;
        public bool CanUndo => true;

        public RoadRemoveCommand(TerrainEditingContext context, TerrainRaycast.TerrainRaycastHit hitResult) {
            _context = context;
            ...
            if (landblockData != null) {
                ...
                _changes.Add((hitResult.LandblockId, hitResult.VerticeIndex, originalRoad, 0));
            }
        }

        public RoadRemoveCommand(TerrainEditingContext context,
